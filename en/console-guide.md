...
#### Assign Public IP  
* For the deployment of TOAST VM instances, create a [Floating IP](https://docs.toast.com/en/Compute/Instance/en/console-guide/#ip_1) for VM instance and assign public IP. 
...
TOAST Deploy supports more functions, and find more details in [Detail Functional Guide](/Dev%20Tool/Deploy/en/reference/).
