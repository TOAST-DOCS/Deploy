...
## Dev Tools > Deploy > Detail Functional Guide { #dev-tools-deploy-detail-functional-guide }
...
* API Upload
    * For more information about API uploads, see [Binary Upload API in the API Guide](/Dev%20Tools/Deploy/en/api-guide-v2.1/#upload-binary).
