...
* [메뉴 설명](/Dev%20Tool/Deploy/zh/reference/#_1)
* [기능 별 설명](/Dev%20Tool/Deploy/zh/reference/#_15)
* [OS 별 요구사항](/Dev%20Tool/Deploy/zh/reference/#os)
...
* API 업로드
    * API 업로드에 대한 상세 내역은 [API 가이드의 Binary Upload API](/Dev%20Tool/Deploy/zh/api-guide/#binary-upload-api) 에서 확인하실 수 있습니다.
* UI 업로드
...
* Jenkins 빌드 설정에 대한 상세 내역은 [플러그인 사용 가이드](/Dev%20Tool/Deploy/zh/plugin-guide/)에서 확인하실 수 있습니다.
