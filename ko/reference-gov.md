...
* [메뉴 설명](/Dev%20Tools/Deploy/ko/reference-gov/#menu-description)
* [기능별 설명](/Dev%20Tools/Deploy/ko/reference-gov/#functional-description)
...
* API 업로드
    * API 업로드에 대한 자세한 설명은 [API 가이드의 Binary Upload API](/Dev%20Tools/Deploy/ko/api-guide-v2.1-gov/#upload-binary)에서 확인하실 수 있습니다.
* 콘솔에서 업로드
