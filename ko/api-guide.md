...
'{
  ...
  ' \
 'https://api-tcd.nhncloudservice.com/api/v1.0/projects/{appkey}/artifacts/{artifactId}/server-group/{serverGroupId}/scenario/{scenarioId}/deploy'
```
...
String requestUri = "https://api-tcd.nhncloudservice.com/api/v1.0/projects/" + appkey + "/artifacts/" + artifactId + "/server-group/" + serverGroupId + "/scenario/" + scenarioId + "/deploy";
