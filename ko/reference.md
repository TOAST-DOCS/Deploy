...
* 배포 이력을 실행일 및 서버 그룹을 기준으로 검색
    * 서버 그룹 선택창 및 실행일 시작일 ~ 종료일로 검색할 수 있습니다.
    * 실행일 기간이 1년을 초과하여 선택할 수 없습니다.(ex. 2020-06-07 ~ 2021-06-17)
     ![deploy_ref_08_2021.png](https://static.toastoven.net/prod_tcdeploy/reference/deploy_ref_08_2021.png)

검색된 배포 이력을 Excel 파일로 다운로드 할 수 있습니다.
...
* 검색된 배포 이력을 Excel 파일로 다운로드
    * 원하는 서버 그룹 및 실행일을 선택한 후 **다운로드** 버튼 클릭합니다.
    * **바이너리 파일 없는 이력 제외** 옵션을 선택하여 다운로드 할 수 있습니다.
