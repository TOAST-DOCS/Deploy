...
> SSH 연결의 경우 target server의 IP, 포트, 방화벽 예외 처리와 같은 [SSH 연결을 위한 준비](/Dev%20Tools/Deploy/ko/setup-guide/#cloud-agent)가 필요합니다.
> Cloud-Agent의 경우 Cloud-Agent 설치, 유효성 확인과 같은 [Cloud-Agent 사용을 위한 준비](/Dev%20Tools/Deploy/ko/setup-guide/#_1)가 필요합니다.
...
> target server의 IP, 포트, 방화벽 예외 처리와 같은 [SSH 연결을 위한 준비](/Dev%20Tools/Deploy/ko/setup-guide/#cloud-agent)가 필요합니다.
