...
1. **Jenkins 관리 > 플러그인 관리 > 고급 탭 > 플러그인 올리기** 메뉴에서 **tcdeploy-upload-jenkins.hpi** 파일을 업로드합니다.
  ([tcdeploy-upload-jenkins.hpi](https://kr1-api-object-storage.nhncloudservice.com/v1/AUTH_2acdfabf4efe4efc8a04c00b348110c9/cdn_origin/prod_tcdeploy/plugins/tcdeploy-upload-jenkins-1.1.2.hpi) 다운로드 링크)
