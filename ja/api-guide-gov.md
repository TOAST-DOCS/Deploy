...
| Http Method | POST |
| ----------- | ---- |
| Request URL | https://gov-api-tcd.cloud.toast.com/api/v1.0/projects/{appkey}/artifacts/{artifactId}/binary-group/{binaryGroupKey} |
...
``` java
curl -X POST \
  https://gov-api-tcd.cloud.toast.com/api/v1.0/projects/{appKey}/artifacts/{artifactId}/binary-group/{binaryGroupKey} \
...
String requestUri = "https://gov-api-tcd.cloud.toast.com/api/v1.0/projects/" + appKey + "/artifacts/" + artifactId + "/binary-group/" + binaryGroupKey;
...
``` json
{
	...
	"body": {
		"downloadUrl": "https://gov-api-tcd.cloud.toast.com/api/v1.0/projects/{appkey}/artifacts/{artifactId}/binary-group/{binaryGroupKey}/binaries/{uploadedBinaryKey}",
...
| Http Method | POST |
| ----------- | ---- |
| Request URL | https://gov-api-tcd.cloud.toast.com/api/binary/upload/artifact/{artifactId} |
...
String requestUri = "https://gov-api-tcd.cloud.toast.com/api/binary/upload/artifact/" + artifactId;
